...
![image-20220512115812323](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220512115812323.png)
...
![image.png](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\1645187878-yPOWXn-image.png)
...
![344.反转字符串](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\008eGmZEly1gp0fvi91pfg30de0akwnq.gif)
...
![替换空格](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\e6c9d24ely1go6qmevhgpg20du09m4qp.gif)
...
![KMP详解1](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲1.gif)
...
回顾一下，刚刚匹配的过程在下标5的地方遇到不匹配，模式串是指向f，如图： ![KMP精讲1](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲1.png)

然后就找到了下标2，指向b，继续匹配：如图： ![KMP精讲2](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲2.png)
...
![KMP精讲5](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲5.png)

长度为前1个字符的子串`a`，最长相同前后缀的长度为0。（注意字符串的**前缀是指不包含最后一个字符的所有以第一个字符开头的连续子串**；**后缀是指不包含第一个字符的所有以最后一个字符结尾的连续子串**。）

![KMP精讲6](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲6.png) 长度为前2个字符的子串`aa`，最长相同前后缀的长度为1。

![KMP精讲7](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲7.png) 长度为前3个字符的子串`aab`，最长相同前后缀的长度为0。

以此类推： 长度为前4个字符的子串`aaba`，最长相同前后缀的长度为1。 长度为前5个字符的子串`aabaa`，最长相同前后缀的长度为2。 长度为前6个字符的子串`aabaaf`，最长相同前后缀的长度为0。

那么把求得的最长相同前后缀的长度就是对应前缀表的元素，如图： ![KMP精讲8](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲8.png)

可以看出模式串与前缀表对应位置的数字表示的就是：**下标i之前（包括i）的字符串中，有多大长度的相同前缀后缀。**

再来看一下如何利用 前缀表找到 当字符不匹配的时候应该指针应该移动的位置。如动画所示：

![KMP精讲2](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲2.gif)
...
![KMP精讲4](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲4.gif)
...
![KMP精讲3](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\KMP精讲3.gif)
...
![image-20220602160809153](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160809153.png)

![image-20220602160815681](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160815681.png)

![image-20220602160835357](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160835357.png)

![image-20220602160841427](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160841427.png)

**不正确**

![image-20220602160951302](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160951302.png)

![image-20220602160957679](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220602160957679.png)
...
>![image-20220630153253233](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220630153253233.png)
>
>![fig1](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\225_fig1.gif)
...
![fig2](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\225_fig2.gif)
...
![image-20220827202215281](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220827202215281.png)
...
![image-20220827220030142](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220827220030142.png)
...
![二叉树前序遍历（迭代法）](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\008eGmZEly1gnbmss7603g30eq0d4b2a.gif)
...
>
> ![前序到后序](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\20200808200338924.png)
>
...
![二叉树中序遍历（迭代法）](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\008eGmZEly1gnbmuj244bg30eq0d4kjm.gif)
...
![102二叉树的层序遍历](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\008eGmZEly1gnad5itmk8g30iw0cqe83.gif)
...
![image-20220831114635671](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\image-20220831114635671.png)
...
![image.png](C:\Users\谭宇乔\Desktop\md\代码随想录.assets\1601259285-fJOatB-image.png)
